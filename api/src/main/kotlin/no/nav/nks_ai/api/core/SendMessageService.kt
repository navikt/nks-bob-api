...
import no.nav.nks_ai.api.core.conversation.streaming.ConversationEvent
import no.nav.nks_ai.api.core.conversation.streaming.diff
...
import no.nav.nks_ai.api.kbs.KbsStreamResponse
import no.nav.nks_ai.api.kbs.fromMessage
import no.nav.nks_ai.api.kbs.toModel
import no.nav.nks_ai.api.kbs.toNewCitation
